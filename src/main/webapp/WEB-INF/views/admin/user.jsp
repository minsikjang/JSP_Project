...
<head>
	...
	<script type="text/javascript">
		$(() => {
			...
			$("#del").click(function () {
				...
				if (delIds == "") {
					...
					if (confirm("삭제하시겠습니까?")) {
						//var url = '<%= request.getContextPath() %>/admin/user.do?delData=' + delIds.substr(1, delIds.length);
		...
		function getUser(idx) {
			...
			var url = '<%= request.getContextPath() %>/admin/user.do?idx=' + idx;
    	 ...
    	 <div class="modal-body">
            ...
            <div class="input-group mb-3">
             	<div class="form-floating">
	               <input type="text" class="form-control vaildation" id="id" placeholder="사번" name="id"/>
	               <label for="floatingInput">사번</label>
             	</div>
         	</div>
          	<div class="input-group mb-3">
	             <div class="form-floating">
	               <input type="text" class="form-control vaildation" id="password" placeholder="비밀번호" name="pwd" maxlength="40">
          	...
          	<div class="input-group mb-3">
	             <div class="form-floating">
	               <input type="text" class="form-control vaildation" id="phone" placeholder="휴대폰번호" name="phone" maxlength="20">
	               <label for="floatingName">휴대폰번호</label>
	             </div>
          	</div>
          	<div class="input-group mb-3">
	             <div class="form-floating">
	               <input type="text" class="form-control vaildation" id="email" placeholder="이메일" name="email" maxlength="20">
